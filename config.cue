...
services: {
	reverse_proxy: {
		...
		conf_path: "\(project.dir)/infra/nginx/local/nginx.conf.template"
    ...
    selfsigned_key_path: "./infra/nginx/local/nginx-selfsigned.key"
    selfsigned_cert_path: "./infra/nginx/local/nginx-selfsigned.crt"
